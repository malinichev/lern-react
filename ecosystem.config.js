...
module.exports = {
    ...
    deploy: {
        production: {
            ...
            'post-deploy': `pwd && yarn install --frozen-lockfile && yarn build:prod --env mode=production apiUrl="http://${DEPLOY_HOST}:8000" && pm2 startOrRestart ecosystem.config.js --env production`,
        },
    },
};
